        ...
        <>
            ...
            <div className="  justify-center p-3  ">
                ...
                <div>
                    ...
                    <section>
                        <h2 className="text-black text-2xl mb-4 font-bold 3px">Terms and Conditions</h2>
                        <p className="text-black text-xl mb-4 3px">
                            Client Consent
                            By booking and receiving services from Bonerve, the client agrees to the terms and conditions outlined herein.<br />
