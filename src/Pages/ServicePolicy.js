        ...
        <>
            ...
            <div className="justify-center p-3">
                ...
                <div className='px-5'>
                    ...
                    This Service Policy governs your use of services provided by Ehikka. By accessing and using our services, you agree to comply with this policy and any other applicable terms and conditions.                    </p>
                    ...
                    <section>
                        ...
                        <p className="text-black text-xl mb-4">
                        Any content you submit or upload to our platforms remains your property. However, by using our services, you grant Ehikka a non-exclusive, worldwide, royalty-free license to use, reproduce, modify, and distribute your content for the purpose of providing and improving our services. Ehikka may remove or disable access to content that violates this policy or is deemed inappropriate or harmful.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-black text-xl mb-4">
                        Ehikka may update this Service Policy to reflect changes in our services or legal requirements. We will notify you of any significant changes. Continued use of our services after the policy changes constitute your acceptance of the updated policy.
                        </p>
                    </section>
