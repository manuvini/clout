    ...
    <footer className=" bg-black">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="flex items-center justify-center space-x-4">
          <a href="https://www.facebook.com/Sproutive/" target="_blank" rel="noopener noreferrer">
            <svg
          ...
          <a href="https://www.instagram.com/Sproutive/" target="_blank" rel="noopener noreferrer">
          <svg
          ...
          <a href="https://twitter.com/Sproutive" target="_blank" rel="noopener noreferrer">
            <svg
              className="h-6 w-6 fill-current text-white hover:text-gray-400"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
